...
class RigolDSG815_RFSigGen(Generic_RFSigGen):
    """Rigol3030DSG RFSigGen, Child of Generic_RFSigGen.

    This class is for communicating with the RigolDSG815 over telnet. The specific API calls abstract the SCPI 
    ...
    def _telnet_query(self, message):
        ...
        Args:
            message (str): SCPI message to be sent to the RigolDSG815

        Returns:
            str: Reply message from the RigolDSG815
        """
        self._telnet_write(message)
        return self._telnet_read()

    def _telnet_write(self, message):
        """Private method that will send a message over telnet to the RigolDSG815 
    ...
    def __init__(self, ipaddress, port = 5555, timeout = 1, limit=-40):
        """Initialises and opens the connection to the RigolDSG815 over telnet and informs the user 

        Args:
            ipaddress (str): The IP address of the RigolDSG815 
    ...
    def __del__(self):
        """Closes the telnet connection to the RigolDSG815
        """
    ...
    def get_device_id(self):
        ...
        if self.DeviceID[0:26] != "Rigol Technologies,DSGDSG815":  # checks it's the right device
    ...
    def get_output_power(self):
        ...
        self.Output_Power = self._telnet_query("SOUR:LEV?") + #self._telnet_query("UNIT:POW?")  # get the power & power units
    ...
    def get_frequency(self):
        ...
        self.Frequency = self._telnet_query("SOUR:FREQ?")  # get the device frequency
    ...
    def set_frequency(self, frequency):
        ...
        self._telnet_write("SOUR:FREQ " + str(self.Frequency) + "MHz")  # Write the frequency value in MHz
    ...
    def set_output_power(self, power):
        ...
        self._telnet_write("SOUR:LEV " + str(power))  # write the new output power
...
#        self._telnet_write("SOUR:LEV:LIM "+ str(limit))  # sets the output level
