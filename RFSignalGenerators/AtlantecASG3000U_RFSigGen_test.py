...
class ExpectedDataTest(BaseTestClass):
    ...
    @patch("RFSignalGenerators.AtlantecASG3000U_RFSigGen._telnet_write")
    @patch("RFSignalGenerators.AtlantecASG3000U_RFSigGen._telnet_query", side_effect = mocked_rigol_replies)
    ...
    @patch("RFSignalGenerators.AtlantecASG3000U_RFSigGen._telnet_write")
    @patch("RFSignalGenerators.AtlantecASG3000U_RFSigGen._telnet_read")
    ...
    @patch("RFSignalGenerators.AtlantecASG3000U_RFSigGen._telnet_write", side_effect=mocked_rigol_writes)
    @patch("RFSignalGenerators.AtlantecASG3000U_RFSigGen._telnet_query", side_effect=mocked_rigol_replies)
