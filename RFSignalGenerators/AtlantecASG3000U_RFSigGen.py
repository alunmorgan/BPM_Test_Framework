...
class AtlantecASG3000U_RFSigGen(Generic_RFSigGen):
    ...
    def _telnet_query(self, message):
        """Private method that will send a message over telnet to the device and return the reply.
    ...
    def __init__(self, ipaddress, port = 5555, timeout = 1, limit=-40):
        """Initialises and opens the connection to the AtlantecASG3000U over telnet and informs the user 

        Args:
            ipaddress (str): The IP address of the AtlantecASG3000U 
