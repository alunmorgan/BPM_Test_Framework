...
def mocked_rigol_replies(input):
    ...
    if input == "LEV?":
        ...
        return "Rigol Technologies,DSG815"
    elif input == "LEV:LIM?":
        return "-40.00"
...
class ExpectedDataTest(BaseTestClass):
    ...
    @patch("RFSignalGenerators.RigolDSG815_RFSigGen._telnet_write")
    @patch("RFSignalGenerators.RigolDSG815_RFSigGen._telnet_query", side_effect = mocked_rigol_replies)
    @patch("telnetlib.Telnet")
    def setUp(self, mock_telnet, mock_telnet_read, mock_telnet_write):
        # Stuff you run before each test
        self.RF_test_inst = RFSignalGenerators.RigolDSG815_RFSigGen("0", 0, 0)
    ...
    @patch("RFSignalGenerators.RigolDSG815_RFSigGen._telnet_write")
    @patch("RFSignalGenerators.RigolDSG815_RFSigGen._telnet_read")
    ...
    def test_get_device_ID(self, mock_telnet_write, mock_telnet_read):
        DeviceID = "Rigol Technologies,DSG815"
    ...
    @patch("RFSignalGenerators.RigolDSG815_RFSigGen._telnet_write", side_effect=mocked_rigol_writes)
    @patch("RFSignalGenerators.RigolDSG815_RFSigGen._telnet_query", side_effect=mocked_rigol_replies)
