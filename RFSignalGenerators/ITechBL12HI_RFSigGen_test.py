...
class ExpectedDataTest(BaseTestClass):
    ...
    @patch("RFSignalGenerators.ITechBL12HI_RFSigGen._telnet_write")
    ...
    def setUp(self, mock_telnet, mock_telnet_read, mock_telnet_write):
        ...
        self.RF_test_inst = RFSignalGenerators.ITechBL12HI_RFSigGen("0", 0, 0)
    ...
    @patch("RFSignalGenerators.ITechBL12HI_RFSigGen._telnet_write")
    @patch("RFSignalGenerators.ITechBL12HI_RFSigGen._telnet_read")
    ...
    @patch("RFSignalGenerators.ITechBL12HI_RFSigGen._telnet_write", side_effect=mocked_itech_writes)
    @patch("RFSignalGenerators.ITechBL12HI_RFSigGen._telnet_query", side_effect=mocked_itech_replies)
